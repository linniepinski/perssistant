...
$is_linkedin_job 	= $job['linkedin_url'] != '' ? true : false;
?>
<li class="list-item">
	<a href="<?php echo $job['permalink'] ?>" target="_blank" data-transition="slide">
		<h2 class="list-title">
			<?php the_title(); ?>
		</h2>
		<p class="list-subtitle">
			<span class="list-info job-loc"><?php echo $job['linkedin_company']; ?></span>
