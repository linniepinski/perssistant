<script type="text/template" id="template_edit_meta">
		...
		<div class="form payment-plan">
			...
			<div class="form-item">
				...
				<select name="field_type" id="field_type" class="chosen-single tax-item">
					...
					<option class=" fix  level-0" value="text"><?php _e("Text", ET_DOMAIN); ?></option>
					<option class=" fix  level-0" value="textarea"><?php _e("Textarea", ET_DOMAIN); ?></option>
				</select>
			</div>
