...
$is_indeed_job 	= $job['indeed_url'] != '' ? true : false;
?>
<li class="list-item">
	<a href="<?php echo $job['indeed_ref_url'] ?>" target="_blank" data-transition="slide">
		<h2 class="list-title">
			<?php the_title(); ?>
		</h2>
		<p class="list-subtitle">
			<span class="list-info job-loc"><?php echo $job['indeed_company']; ?></span>
