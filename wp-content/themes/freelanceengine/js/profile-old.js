(function($, Models, Collections, Views) {
    ...
    Views.Profile = Backbone.View.extend({
        ...
        events: {
            ...
            'click a.request-confirm': 'requestConfirmMail'						// authorize credit card			'submit form#finance_form': 'authorizeCreditCard',
        },
...
//            console.log('vaoo');
        ...
        initValidator: function() {
            ...
            });						// login rule            this.credit_card_validator = $("form#finance_form").validate({                rules: {                    card_type: "required",										card_number: {						required :  true,						number :	true,						min : 16					},										card_month: {						required : true,						number : true,						min : 2					},										card_month: {						required : true,						number : true,						min : 2					},										card_cvv: {						required : true,						number : true,						min : 3					}                }            });
        },
        /**
        ...
        },				/**		 * Authorize credit card		 *		 */		 		authorizeCreditCard = function(event) {						event.preventDefault();            event.stopPropagation();            /**             * call validator init             */            this.initValidator();						var form = $(event.currentTarget),			button = form.find('.btn-submit'),			view = this,			temp = new Array();						/**             * scan all fields in form and set the value to model user             */            form.find('input, textarea, select').each(function() {                view.profile.set($(this).attr('name'), $(this).val());            });						if (this.credit_card_validator.form() && !form.hasClass("processing")) {											}			}
    });
    /*
     *
