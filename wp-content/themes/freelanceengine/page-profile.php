                ...
                if (get_user_meta($user_ID, 'interview_status', true) == 'unconfirm') {
                    ...
                    <div class="col-md-12" style="margin-top: 25px">
                        <div class="alert alert-warning" role="alert">
                            Your profile is not activated. To activate you profile you need to pass the interview - <a
                                href="/interview">Interview details</a>
                        </div>
                    </div>
                <?php
                        ...
                        <div class="form-group-control">
                            <div class="form-group-control">
                                ...
                                <?php if (ae_user_role() != FREELANCER) { ?>
                                    <select class="chosen multi-tax-item tax-item required cat_profile" id="location"
                        ...
                        if (ae_user_role() != FREELANCER) {
                            ...
                            <div class="form-group">
                                <div class="form-group-control">
                                    ...
                                    <select class="chosen multi-tax-item tax-item required cat_profile"
                                            id="default_payment_option" name="default_payment_option"
                                            data-placeholder="Choose Payment Option" data-chosen-disable-search=""
                                            data-chosen-width="95%">
                                        <option value="paypal" class="paypal level-0" <?php echo $strPayPalSelected; ?>>
                                            PayPal
                                        </option>
                                        <?php
                        ...
                        <?php
                            ...
                            <div class="form-group">
                                <div class="form-group-control">
                                    ...
                                    <select class="chosen multi-tax-item tax-item required cat_profile"
                                            id="default_payment_option" name="default_payment_option"
                                            data-placeholder="Choose country" data-chosen-disable-search=""
                                            data-chosen-width="95%">
                                        <option value="paypal" class="paypal level-0" <?php echo $paypalSelected; ?>>
                                            PayPal
                                        </option>
                                        <option value="bank_account"
                                                class="bank_account level-0" <?php echo $bankSelected; ?>>Bank Account
                                        </option>
                                    </select>
                                </div>
                            </div>
                ...
                <form class="form-detail-profile-page" id="profile_form">
                    ...
                    <div class="form-group ">
                        <div class="form-group-control">
                            ...
                            <input class="form-control" type="text" id="et_professional_title"
                                   name="et_professional_title" value="<?php echo $job_title ?>"
                    ...
                    <div class="form-group">
                        <div class="form-group-control">
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" id="hour_rate" name="hour_rate"
                    ...
                    <div class="form-group">
                        <div class="form-group-control">
                            ...
                            <select class="chosen multi-tax-item tax-item required cat_profile" id="country"
                                    name="country" data-placeholder="Choose country" data-chosen-disable-search=""
                                    data-chosen-width="95%">
                                <?php
                                if (!empty($country_list)) {
                                    foreach ($country_list as $key => $value) {
        ...
        <div class="tab-pane fade" id="tab_finance_details">
            <div class="row">
                ...
                <div class="detail-profile-page col-md-10 col-md-offset-1 saveCardw">
                    <div class="saveCard">
                        <h5 style=" padding-bottom: 5px;border-bottom:1px solid #f4f4f4;">Saved Cards</h5>
                        <?php
                        $arrCCDetails = $wpdb->get_results('SELECT * FROM wp_user_cc_info WHERE user_id = ' . $user_ID);
                        $default_payment = get_user_meta($user_ID, 'default_payment_option', true);
                        $default_cc = get_user_meta($user_ID, 'active_cc', true);
                                ...
                                foreach ($arrCCDetails as $cc) {
                                    ...
                                    <li>
                                        ...
                                        <a class="remove-cc" href="javascript:void(0)"
                                           onclick="remove_card('<?php echo $cc->cc_id; ?>');">Remove Card</a>
                                    </li>
                                <?php
                                }
                                ?>
                    ...
                    <form class="form-detail-profile-page" id="finance_form">
                        ...
                        <div class="form-group">
                            <div class="form-group-control">
                                ...
                                <select style="width:250px;" class="chosen multi-tax-item tax-item required cat_profile"
                                        id="card_type" name="card_type" data-placeholder="Choose Card Type"
                                        data-chosen-disable-search="" data-chosen-width="95%">
                                    <option value="VISA" class=" VISA  level-0">Visa</option>
                                    <option value="MasterCard" class=" MasterCard  level-0">Master</option>
                                    <option value="Discover" class=" Discover  level-0">Discover</option>
                                    <option value="Amex" class=" Amex  level-0">Amex</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-group-control">
                                ...
                                <p>
                                    <input class="form-control" type="text" name="exp_month" id="exp_month" value=""
                                           placeholder="<?php _e("MM", ET_DOMAIN) ?>" style="width:48%; float:left">
                                    <input class="form-control" type="text" name="exp_year" id="exp_year" value=""
                                           placeholder="<?php _e("YY", ET_DOMAIN) ?>" style="width:48%; float:right">
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-group-control">
                                ...
                                <input class="form-control" type="text" name="card_cvv" id="card_cvv" value=""
                        ...
                        <div class="form-group">
                            <div class="form-group-control">
                                ...
                                <select style="width:250px;" class="chosen multi-tax-item tax-item required cat_profile"
                                        id="user_country" name="user_country" data-placeholder="Choose Country"
                                        data-chosen-disable-search="" data-chosen-width="95%">
                        ...
                        <div class="form-group">
                            <div class="form-group-control">
                                ...
                                <input class="form-control" type="checkbox" name="default_payment" id="default_payment"
                                       value="">
                            </div>
                        </div>
    ...
    <?php if (ae_user_role() == FREELANCER) { ?>
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <select class="chosen multi-tax-item tax-item required cat_profile" id="account_type"
                        name="account_type" data-placeholder="Choose Account Type"
                        data-chosen-disable-search="" data-chosen-width="95%">
                    <option value="current_account" class=" current_account  level-0">Checking/Current
                    </option>
                    <option value="saving" class=" saving  level-0">Saving</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <select class="chosen multi-tax-item tax-item required cat_profile" id="bank_country"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="routing_no" name="routing_no"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="bank_state" name="bank_state"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="account_holder_currency"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="account_holder_address"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="account_holder_city"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="account_holder_state"
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <select class="chosen multi-tax-item tax-item required cat_profile"
                        id="account_holder_country" name="account_holder_country"
                        data-placeholder="Choose country" data-chosen-disable-search=""
                        data-chosen-width="95%">
                    <?php
                    if (!empty($country_list)) {
        ...
        <div class="form-group">
            <div class="form-group-control">
                ...
                <input type="text" class="form-control" id="account_holder_zipcode"
        ...
        <div class="setting-profile-wrapper <?php echo $user_role; ?>">
                ...
                <div class="form-group">
                    <div class="text-small">
                        ...
                        <div class="profile-completion-status"><span
                                style="width:<?php echo $totalPercent; ?>%"><?php echo $totalPercent; ?>%</span></div>
            ...
            <form name="verify_user_phone" id="verify_user_phone">
                ...
                <div class="form-group confirm-request verified"
                    ...
                    <span id="user_verified_mobile"><i class="fa fa-check"></i> <?php echo $user_mobile; ?></span>
                    <button type="button" class="btn-submit"
            ...
            <ul class="list-setting">
                <?php if (fre_share_role() || $user_role != FREELANCER) { ?>
                    <li>
                        <a role="menuitem" tabindex="-1" href="<?php echo et_get_page_link("submit-project") ?>"
                           class="display-name">
