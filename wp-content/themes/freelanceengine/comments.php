...
<div id="comments" class="comments-area et-comments-area">
	...
	<div class="btm-comment-form">
		<?php
			comment_form ( array(
							'comment_field'        => ' <div class="form-item"><label for="comment">' . __( 'Your Comment', 'comments' ) . '</label><div class="input"><textarea class="form-control" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></div></div>',
