    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e("Edit item for your Portfolio", 'modal-edit-portfolio') ?></h4>
            </div>
            <div class="modal-body">
                <form id="edit_portfolio" class="auth-form edit_portfolio">
                    ...
                    <div id="portfolio_img_edit_container">
                        ...
                        <p class="add-file"><?php _e('ADD FILES', 'modal-edit-portfolio') ?></p>

                        <p class="drag-drop"><?php _e('Simply Drag & Drop', 'modal-edit-portfolio') ?></p>
                    ...
                    <div class="form-group">
                        <label><?php _e('Portfolio Title', 'modal-edit-portfolio') ?></label>

                        <p><input type="text" name="post_title" id="post_title"/></p>
                    </div>
                    <div class="form-group">
                        <label><?php _e('Portfolio Description', 'modal-edit-portfolio') ?></label>
                        <textarea name="post_content" id="post_content"></textarea>
                    </div>
                    <div class="clearfix"></div>
                    <div class="form-group portfolio-skills">
                        <label><?php _e('Select Skill', 'modal-edit-portfolio') ?></label>
...
<!--                        </p>-->
                            ...
                            if (!$switch_skill) {
                                ...
                                <input class="form-control skill" type="text" id="skill"
                                       placeholder="<?php _e("Skills (max is 10)", 'modal-edit-portfolio'); ?>"
                                       name=""
                                ...
                                ae_tax_dropdown('skill', array('attr' => 'data-chosen-width="95%" multiple data-chosen-disable-search="" data-placeholder="' . __(" Skills (max is 10)", 'modal-edit-portfolio') . '"',
                    ...
                    <button type="submit" class="btn-submit btn-sumary btn-sub-create">
                        <?php _e('Add item', 'modal-edit-portfolio') ?>
                    </button>
                </form>
            </div>
        </div>
