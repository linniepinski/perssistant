            ...
            <div class="row">
                <div class="col-md-3 col-xs-6 chosen-sort"> 
                    <select class="sort-order chosen-select" id="project_orderby" name="orderby" 
                        data-placeholder="<?php _e("Orderby", 'taxonomy-project_type'); ?>" data-chosen-disable-search="1" data-chosen-width="90%" style="display: none;">
                        <option value="date"><?php _e('Newest Projects first','taxonomy-project_type');?></option>
                        <option value="et_featured"><?php _e('Featured Projects first','taxonomy-project_type');?></option>
                        <option value="et_budget"><?php _e('Budget Projects first','taxonomy-project_type');?></option>
                    </select>                 
                </div>
                    ...
                    <div class="tab-content-project">
                        <div class="row title-tab-project">
                            <div class="col-md-5 col-sm-5 col-xs-7">
                                <span><?php _e("PROJECT TITLE", 'taxonomy-project_type'); ?></span>
                            </div>
                            <div class="col-md-2 col-sm-3 hidden-xs">
                                <span><?php _e("BY", 'taxonomy-project_type'); ?></span>
                            </div>
                            <div class="col-md-2 col-sm-2 hidden-sm hidden-xs">
                                <span><?php _e("POSTED DATE", 'taxonomy-project_type'); ?></span>
                            </div>
                            <div class="col-md-1 col-sm-2 hidden-xs">
                                <span><?php _e("BUDGET", 'taxonomy-project_type'); ?></span>
                            </div>
                        </div>
                        <!-- Tab panes -->
