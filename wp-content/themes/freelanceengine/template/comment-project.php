...
<div id="comments" class="project-comments comments-area et-comments-area">
	...
	<nav id="comment-nav-below" class="navigation comment-navigation" role="navigation">
		<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'comment-project' ) ); ?></div>
		<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'comment-project' ) ); ?></div>
	...
	<p class="no-comments et-comments-title">
		<?php _e( 'Comments are closed.', 'comment-project' ); ?>
	</p>
	<?php endif; ?>
	<div class="btm-comment-form">
		<?php 
			comment_form ( array(
							'comment_field'        => ' <div class="form-item"><label for="comment">' . __( 'Your Comment', 'comment-project' ) . '</label><div class="input"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></div></div>',
							'comment_notes_before' => '',
							'comment_notes_after'  => '',
							'id_form'              => 'commentform',
							'id_submit'            => 'submit',
							'title_reply'          => __( "Comment", 'comment-project'),
							'title_reply_to'       => __( 'Leave a Reply to %s', 'comment-project'),
							'cancel_reply_link'    => __( 'Cancel reply','comment-project' ),
							'label_submit'         => __( 'Comment', 'comment-project' ),
					) );
		?>
	</div>
            ...
            <div class="media-body">
                ...
                <?php 
                    comment_reply_link(array_merge($args, array(
						'reply_text' => __( 'Reply ', 'comment-project' ),
						'depth'      => $depth,
