            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo home_url(); ?>"><?php _e('Home','single-project-breadcrumb'); ?></a></li>
                            <?php 
                            $first_tax = array();
                    ...
                    <div class="col-md-6 col-xs-4 prj-next-link">
                        <?php next_post_link( '%link', __('Next project <i class="fa fa-angle-double-right"></i>','single-project-breadcrumb') ) ; ?>                        
                    </div>
                    */ ?>
                </div>
            </div>
