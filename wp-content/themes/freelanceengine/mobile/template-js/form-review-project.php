...
<form id="review_form" class="review-form review-form-mobile" <?php if($review != 1) echo 'style ="display:none"';?> >
    <div class="form-group rate">
        ...
        <label for="post_content"><?php _e('Rate for this profile','form-review-project-mobile');?> </label>
    ...
    <div class="form-group">
        ...
        <label for="post_content"><?php _e('Message review profile ','form-review-project-mobile'); ?></label>
    ...
    <button type="submit" class="btn-submit btn btn-primary btn-sumary btn-sub-create">
        <?php _e('Submit', 'form-review-project-mobile') ?>
    </button>
</form> 