        ...
        <div class="search-normal-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-4"><a href="#" class="show-search-advance"><?php _e("Advanced", 'archive-fre_profile'); ?></a></div>
                    <div class="col-xs-4"><a href="#" class="hide-search-advance" style="display:none;"><?php _e("Cancel", 'archive-fre_profile'); ?></a></div>
                </div>
            </div>
