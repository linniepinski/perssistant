                ...
                <?php if( !$user_ID && $project_status == 'publish'){ ?>
                        ...
                        if($project_status == 'publish'){
                            if($role == FREELANCER){
                                ...
                                if( $has_bid ) {                                                                   
                                    ?>                                       
                                    <a rel="<?php echo $project->ID;?>" href="#" id="<?php echo $has_bid;?>" title= "<?php _e('Delete this bidding','single-project-mobile'); ?>"  class="btn-bid btn-del-project" ><?php  _e('Cancel','single-project-mobile');?></a>
                                ...
                                <a href="#" id="<?php the_ID();?>"  class="btn-apply-project-item btn-bid" ><?php  _e('Opening','single-project-mobile');?></a>
                                <?php 
                            }
