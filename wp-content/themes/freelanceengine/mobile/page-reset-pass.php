    ...
    <div class="tabs-acc-details tab-profile" id="tab_change_pw">
        <form class="form-mobile-wrapper form-user-profile chane_pass_form" id="resetpass_form">
            ...
            <div class="form-group-mobile edit-profile-title">
                <label><?php _e("Your New Password", 'page-reset-pass-mobile') ?></label>
                <input type="password" id="new_password" name="new_password" placeholder="<?php _e("New password", 'page-reset-pass-mobile'); ?>">
            </div>
            <div class="form-group-mobile">
                <label><?php _e("Retype New Password", 'page-reset-pass-mobile') ?></label>
                <input type="password" id="re_new_password" name="re_new_password" placeholder="<?php _e("Retype New password", 'page-reset-pass-mobile'); ?>">
            </div>
            <p class="btn-warpper-bid">
                <input type="submit" class="btn-submit btn-sumary btn-bid" value="<?php _e("Reset", 'page-reset-pass-mobile') ?>" />
            </p>
        </form>
    </div>    
</section>
