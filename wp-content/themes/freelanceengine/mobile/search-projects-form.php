<form class="form-search-wrapper">
    ...
    <div class="form-group">
        <label><?php _e("Skills", 'search-projects-form-mobile'); ?></label>
    ...
    <div class="form-group">
        <button class="btn-sumary btn-search-advance reset-mobile"><?php _e("Reset", 'search-projects-form-mobile'); ?></button>
    </div>
